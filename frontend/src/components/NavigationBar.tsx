...
const NavigationBar: React.FC = () => (
  <nav className="w-full bg-white border-b border-neutral-200 shadow-sm py-3 px-6 flex items-center justify-between sticky top-0 z-10">
    ...
    <div className="flex gap-4">
      <Link className="text-neutral-700 hover:text-blue-600 font-medium transition" to="/">
        Home
      </Link>
      <Link className="text-neutral-700 hover:text-blue-600 font-medium transition" to="/recipes">
        Recipes
      </Link>
      <Link
